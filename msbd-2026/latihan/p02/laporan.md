...
4. Apa perbedaan antara entitas Venue dan Stage_Schedule? Venue merepresentasikan lokasi fisik secara umum (misalnya "Stadion Utama GBK" dengan kapasitas tetapnya), sedangkan Stage_Schedule merepresentasikan jadwal spesifik panggung yang diadakan di suatu venue pada tanggal/waktu tertentu. Satu Venue dapat memiliki banyak Stage_Schedule di event yang berbeda-beda dari waktu ke waktu. Pemisahan ini penting agar sistem dapat melacak penggunaan panggung secara dinamis. Pertanyaan bisnis yang hanya bisa dijawab jika dipisah adalah: "Panggung mana saja di Venue tertentu yang memiliki jadwal bentrok waktu tampil artist pada akhir pekan ini?" — pertanyaan ini membutuhkan data waktu spesifik dari Stage_Schedule yang terikat pada suatu Venue.
